...
<?php
    ...
    echo '<a href="https://' . $CHALLHOST . '/ctf-tool-xterm_' . $_SESSION['uid'] . '/" target="_blank"><pre>[Cliquer ICI pour ouvrir mon terminal dans un nouvel onglet]</pre></a>';
    echo "</br>";
    ...
    echo "</br>Pour changer la taille de la fonte, saisir dans la console javascript : </br>term.setOption('fontSize', 16); term.fit();";
    echo '<p id="MyTerm">...</p></br>';
    //echo($yo['Name']);
    /*
