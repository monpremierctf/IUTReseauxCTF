...
function qcm_cb_clicked(checkbox, id, flag_field, isMultiplechoice=false){
    var checkboxes = document.getElementsByName(id);
    var checkboxesChecked = [];

    // not multiple choice
    if (! isMultiplechoice) {
        $('input[name="' + id + '"]').not(checkbox).prop('checked', false);
    }
    // loop over them all
    ...
    $(flag_field).val(JSON.stringify(checkboxesChecked));
